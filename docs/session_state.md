...
1. **Role & Account Variants** (`1:13`) — In-app notifications panel.
2. **App Shell** (`1:2`) — account menu, switch-account modal, topbar search states, account switcher panel.
