...
- **STILL FLAT (hand-built, not yet rebuilt to auto-layout):** the other 8 Bulk Upload frames — Column Mapper (`70:107`), Review (`71:45`), Error Rows (`128:51`), All Fixed (`129:51`), and the 4 modals (`71:175/184/196/230`). Content is faithful (S9/S13) but layer structure is still absolute. Recommend same code-DOM rebuild next.
